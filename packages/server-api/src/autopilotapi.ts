...
import type {
  AutopilotStateDefType,
  AutopilotActionDefType,
  AutopilotOptionsType,
  AutopilotInfoType
...
/** @category  Autopilot API  */
export type AutopilotStateDef = AutopilotStateDefType
/** @category  Autopilot API  */
export type AutopilotActionDef = AutopilotActionDefType
/** @category  Autopilot API  */
export type AutopilotOptions = AutopilotOptionsType
/** @category  Autopilot API  */
export type AutopilotInfo = AutopilotInfoType
