...
// Data-shape types are derived from the TypeBox schemas in
// `./typebox/ble-schemas`, which are the single source of truth for
// OpenAPI generation and runtime validation. The method-bearing
// interfaces below (which TypeBox cannot represent) are defined here.
export type {
  BLEAdvertisement,
  BLEDeviceInfo,
  BLEConsumerInfo,
...
} from './typebox/ble-schemas'

import type { BLEAdvertisement, BLEDeviceInfo } from './typebox/ble-schemas'
