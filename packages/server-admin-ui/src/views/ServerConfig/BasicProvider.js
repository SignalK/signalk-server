...
const NMEA2000 = (props) => {
  return (
    <div>
      ...
      <option value="w2k-1-n2k-ascii-canboatjs">W2K-1 N2K ASCII (canboatjs)</option>
      <option value="w2k-1-n2k-actisense-canboatjs">W2K-1 N2K ACTISENSE (canboatjs)</option>
