       ...
       <CardHeader>
        ...
        <CardBody>
          <Table hover responsive bordered striped size="sm">
            ...
            return (
                <tr key={req.accessIdentifier} onClick={this.requestClicked.bind(this, event, req, index)}>
      ...
      <Card>
        ...
        <CardBody>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Label>{this.state.selectedRequest.accessIdentifier}</Label>
            </Col>
          </FormGroup>
          <FormGroup row>
            <Col md="2">
            ...
            <Col xs="12" md="9">
              <Label>{this.state.selectedRequest.accessDescription}</Label>
            </Col>
          </FormGroup>
          <FormGroup row>
            <Col md="2">
        ...
        <CardFooter>
          <Row>
            <Col xs="4" md="1">
              <Button size="sm" color="danger" onClick={this.handleAccessRequest.bind(this, this.state.selectedRequest.accessIdentifier, true)}><i className={this.state.accessRequestsApproving.indexOf(this.state.selectedRequest.accessIdentifier) != -1 ? "fa fa-spinner fa-spin" : "fa fa-plus-circle"}></i> Approve</Button>
 
            </Col>
            <Col xs="4" md="1">
               <Button size="sm" color="primary" onClick={this.handleAccessRequest.bind(this, this.state.selectedRequest.accessIdentifier, false)}><i className={this.state.accessRequestsDenying.indexOf(this.state.selectedRequest.accessIdentifier) != -1 ? "fa fa-spinner fa-spin" : "fa fa-ban"}></i> Deny</Button>
            </Col>
          </Row>
        </CardFooter>
      </Card>
