...
// reflects bus-level instance conflicts regardless of which view is
// mounted. The badge subscribes outside the SourceDiscovery component
// tree so navigating away does not freeze the count.
useStore.subscribe(
  (s) => ({
