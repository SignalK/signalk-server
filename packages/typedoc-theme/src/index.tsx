...
export function load(app: Application) {
	...
	app.on('bootstrapEnd', () => {
		if (app.options.isSet('theme') && app.options.getValue('theme') !== 'signalk') {
			return app.logger.warn(
				`The theme 'signalk' is not used because another theme (${app.options.getValue('theme')}) was specified!`
			);
		}
