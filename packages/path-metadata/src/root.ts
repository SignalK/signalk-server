...
export const rootMetadata: Record<string, PathMetadataEntry> = {
  ...
  '/sar': {
    description:
      "A wrapper object for Search And Rescue (SAR) MMSI's used in transponders. MOB, EPIRBS etc"
  },
  '/sar/*': {
    description:
      'This regex pattern is used for validation of an MMSI or Signal K UUID identifier for a Search And Rescue device. Examples: urn:mrn:imo:mmsi:972099999 urn:mrn:signalk:uuid:c0d79334-4e25-4245-8892-54e8ccc8021d'
  },
  '/resources': {
    description:
