...
export const rootMetadata: Record<string, PathMetadataEntry> = {
  ...
  '/sar/*': {
    description:
      'This regex pattern is used for validation of an MMSI or Signal K UUID identifier for SAR transponders. Examples: urn:mrn:imo:mmsi:972099999 urn:mrn:signalk:uuid:c0d79334-4e25-4245-8892-54e8ccc8021d'
  },
  '/resources': {
    description:
