import {
  ...
  BLEGatewayHelloSchema,
  BLEGattCommandSchema,
  BLEGattSessionEventSchema,
  BLEGatewayStatusSchema
    ...
    gatewayGatt: {
      ...
      messages: {
        ...
        gattData: {
          ...
          contentType: 'application/json',
          payload: BLEGattSessionEventSchema
        },
        gatewayStatus: {
          name: 'status',
          ...
          contentType: 'application/json',
          payload: BLEGatewayStatusSchema
        }
      }
    }
  },
