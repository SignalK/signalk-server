...
The SignalK specification defines a number of resources (routes, waypoints, notes, regions & charts) each with its own path under the root `resources` path _(e.g. `/signalk/v1/api/resources/routes`)_.
...
```typescript
HTTP POST 'http://hostname:3000/signalk/v1/api/resources/routes' {resource_data}
```
...
```typescript
HTTP PUT 'http://hostname:3000/signalk/v1/api/resources/waypoints/urn:mrn:signalk:uuid:94052456-65fa-48ce-a85d-41b78a9d2111'
```
...
```typescript 
HTTP POST 'http://hostname:3000/signalk/v1/api/resources/routes' {
  points: [
    {latitude: -38.567,longitude: 135.9467},
    {latitude: -38.967,longitude: 135.2467},
    {latitude: -39.367,longitude: 134.7467},
...
```typescript
HTTP POST 'http://hostname:3000/signalk/v1/api/resources/waypoints' {
  position: {
    latitude: -38.567,
    longitude: 135.9467
  }
...
```typescript
HTTP POST 'http://hostname:3000/signalk/v1/api/resources/regions' {
  points: [
    {latitude: -38.567,longitude: 135.9467},
    {latitude: -38.967,longitude: 135.2467},
    {latitude: -39.367,longitude: 134.7467},
