...
// Verifies that the SeaTalk1 input filter correctly discards datagrams by their
// hex command byte (e.g. 84 for depth, 9C for compass heading) using word
// boundary matching to prevent partial matches, while leaving NMEA0183
// sentences unaffected.
