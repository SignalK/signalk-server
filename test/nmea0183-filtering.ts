...
// Verifies that the NMEA0183 input filter correctly discards sentences by their
// three-letter identifier (e.g. RMC, GGA) regardless of talker id, while
// leaving unrelated protocols like SeaTalk1 unaffected.
