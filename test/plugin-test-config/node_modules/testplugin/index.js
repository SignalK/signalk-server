module.exports = function(app) {
  return {
    ...
    start: function() {
      ...
      //A very crude test that just just checks that the api can
      //be called. /test/plugins.js tests asserts that the
      //plugin is started
      app.courseAPI.course.putCourseArrivalCircle({ value: 500 })
      this.started = true
