...
/**
 * assembly/index/resources_set_resource
 * @param requestJson `~lib/string/String`
 * @returns `~lib/string/String`
 */
export declare function resources_set_resource(requestJson: string): string
/**
 * assembly/index/resources_delete_resource
 * @param requestJson `~lib/string/String`
 * @returns `~lib/string/String`
 */
export declare function resources_delete_resource(requestJson: string): string
