...
Signal K Server supports OpenID Connect (OIDC) authentication, enabling Single Sign-On (SSO) with enterprise identity providers such as Keycloak, Authentik, Auth0, Okta, and others.

## Overview

OIDC authentication provides:

- **Single Sign-On (SSO)**: Users authenticate once with your identity provider
