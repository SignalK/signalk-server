...
module.exports = function (app) {
  ...
  function updateProvider (idToUpdate, provider, res) {
    let isNew = _.isUndefined(idToUpdate) || idToUpdate === null
    ...
    if (applyProviderSettings(updateProvider, provider, res)) {
      if (isNew) {
        app.config.settings.pipedProviders.push(updateProvider)
      }
