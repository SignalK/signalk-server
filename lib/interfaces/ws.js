...
module.exports = function(app) {
  ...
  api.start = function() {
    ...
    if ( app.securityPlugin )
    {
      app.securityPlugin.setupWS(primus)
    }
    ...
    primus.on('connection', function(spark) {
      ...
      var onChange = function(data) {
        if ( app.securityPlugin && app.securityPlugin.verifyWS(spark) == false )
        {
      ...
      spark.on('data', function(msg) {
        ...
        if (msg.updates) {
          if ( app.securityPlugin && app.securityPlugin.shouldAllowWrite(spark) == false )

          {
            debug("security dissalowed update")
            return
          }
