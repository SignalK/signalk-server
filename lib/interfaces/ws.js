...
module.exports = function(app) {
  ...
  api.start = function() {
    ...
    {
      app.securityStrategy.setupWS(primus)
    }
    ...
    primus.on('connection', function(spark) {
      ...
      var onChange = function(data) {
        if ( app.securityStrategy && !app.securityStrategy.verifyWS(spark) ) {
          spark.end('{message: "Connection disconnected by security constraint"}', { reconnect: true });
          return
        }
      ...
      spark.on('data', function(msg) {
        ...
        if (msg.updates) {
          if ( app.securityStrategy && !app.securityStrategy.shouldAllowWrite(spark) )
