...
module.exports = function(app) {
  ...
  if(typeof app.config.defaults == 'object' && typeof app.config.defaults.vessels == 'object' && typeof app.config.defaults.vessels.self == 'object' && typeof app.config.defaults.vessels.self === 'object' && app.config.defaults.vessels.self !== null && (typeof app.config.defaults.vessels.self.uuid === 'string' || typeof app.config.defaults.vessels.self.mmsi === 'string')) {
    uuid = app.config.defaults.vessels.self.uuid;
    mmsi = app.config.defaults.vessels.self.mmsi;
  } else if(typeof app.config.settings.vessel === 'object' && app.config.settings.vessel !== null && (typeof app.config.settings.vessel.uuid === 'string' || typeof app.config.settings.vessel.mmsi === 'string')) {
  ...
  if ( app.selfType )
  {
    ...
    if ( app.selfType == 'mmsi' )
      app.config.defaults.vessels.self.uuid = 'urn:mrn:signalk:mmsi:' + app.selfId;
  }
};
