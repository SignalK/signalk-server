...
module.exports = function(app) {
  ...
  function createPipeElement(elementConfig) {
    ...
    if (elementConfig.cliArgumentMappings) {
      elementConfig.cliArgumentMappings.forEach(function(cliArgumentMapping) {
        if (app.argv[cliArgumentMapping.fromArgument]) {
          options[cliArgumentMapping.toOption] = app.argv[cliArgumentMapping.fromArgument]
        }
      });
    }
    try {
