...
module.exports = function(app) {
  function createPipedProvider(providerConfig, nmea0183Listener) {
    ...
    if (typeof providerConfig.enabled != 'undefined'
    ...
    result.pipeElements = result.pipeElements.filter(function(n){return n != null});
  ...
  function createPipeElement(elementConfig) {
    ...
    if (typeof elementConfig.enabled != 'undefined'
  ...
  function startProviders() {
    ...
    if (app.config.settings.pipedProviders) {
      piped = app.config.settings.pipedProviders.map(function(providerConfig) {
