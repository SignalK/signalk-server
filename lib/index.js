...
function Server(opts) {
  ...
  if ( app.config.settings.authentication && app.config.settings.authentication.plugin )
  {
    app.securityPlugin = require(app.config.settings.authentication.plugin)(app)
  }
