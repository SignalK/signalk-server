...
function Server(opts) {
  ...
  debug(JSON.stringify(app.config.settings.authentication))
  if ( !_.isUndefined(app.config.settings.authentication) 
       && _.isBoolean(app.config.settings.authentication.enabled)
       && app.config.settings.authentication.enabled
     )
  {
    debug("authentication is on")
    passport.use(new LocalStrategy(
      {
        passReqToCallback : true
      },
      function(req, username, password, done) {
        if ( app.config.settings.authentication.username == username
             && app.config.settings.authentication.password == password ) {
    ...
    app.authenticationMiddleware = function() {  
  ...
  app.get('/', app.authenticationMiddleware(), (req, res) => {
  ...
  app.use('/apps/*', app.authenticationMiddleware())
  app.use('/apps', app.authenticationMiddleware())
