...
Server.prototype.start = function() {
  ...
  _.forIn(availableInterfaces, function(interface, name) {
    if(_.isUndefined(app.config.settings.interfaces) || (_.isObject(app.config.settings.interfaces) && !_.isUndefined(app.config.settings.interfaces[name]))) {
  ...
  if(Object.keys(app.interfaces).length > 0) {
