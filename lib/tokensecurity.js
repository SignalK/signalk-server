...
module.exports = function (app, config) {
  ...
  function setupApp () {
    ...
    app.use('/signalk/*', function (req, res, next) {
      no_redir(req, res, next)
    })
    app.put('/signalk/*', writeAuthenticationMiddleware(false))
    app.post('/signalk/*', writeAuthenticationMiddleware(false))
  }
  ...
  strategy.addAdminWriteMiddleware = function (path) {
    app.use(path, http_authorize(false))
    app.put(path, adminAuthenticationMiddleware(false))
    app.post(path, adminAuthenticationMiddleware(false))
  }
