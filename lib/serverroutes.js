...
module.exports = function(app, saveSecurityConfig, getSecurityConfig) {
  ...
  app.get('/loginStatus', (req, res, next) => {
    let result = {
      ...
      securityWasEnabled: !_.isUndefined(securityWasEnabled)
    }
  ...
  app.get('/settings', (req, res, next) => {
    var settings = {
      ...
      options: {
        ...
        enablePluginLogging: app.config.settings.enablePluginLogging || false
      },
  ...
  if (
    app.securityStrategy == null ||
    app.securityStrategy.getUsers().length == 0
  ) {
    app.post('/enableSecurity', (req, res, next) => {
      if (app.securityStrategy == null) {
