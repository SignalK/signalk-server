...
function contextMatcher (selfContext, app, subscribeCommand, errorCallback) {
  ...
  if (subscribeCommand.context) {
    if (typeof subscribeCommand.context === 'string') {
      ...
      typeof subscribeCommand.context.relativePosition !== 'undefined'
    ) {
      var relativePosition = subscribeCommand.context.relativePosition
      if (typeof relativePosition.radius === 'undefined') {
        errorCallback('Please specify a radius for relativePosition')
        return x => false
      } else if (
        typeof relativePosition.latitude === 'undefined' ||
        typeof relativePosition.longitude === 'undefined'
      ) {
        errorCallback(
          'Please specify latitude and longitude for relativePosition'
        )
        return x => false
      }
      return normalizedDeltaData => {
